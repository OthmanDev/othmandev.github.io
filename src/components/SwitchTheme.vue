<template>
  <div class="fixed top-40 z-10 w-11 h-11 bg-white dark:bg-dark-100 rounded-tr-lg rounded-br-lg border border-dark-75 border-l-0 border-opacity-70 dark:border-white dark:border-opacity-10">
